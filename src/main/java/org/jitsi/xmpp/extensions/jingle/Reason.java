...
public enum Reason {
    ...
    /**
     * A reason indicating that the action is generated during the normal course
     * of state management and does not reflect any error.
     */
    SUCCESS("success"),
    /**
     * A reason indicating that a request has not been answered so the sender is
    ...
    /**
     * A reason indicating that the party supports none of the offered transport
     * methods.
     */
     ...
     *
     * @param reasonValue the name of the <tt>JingleAction</tt> we'd like to
     * create.
     */
     ...
     * <tt>reasonValueStr</tt> or in other words {@link #SUCCESS} for "success"
     * or {@link #TIMEOUT} for "timeout").
     *
     * @param reasonValueStr the action <tt>String</tt> that we'd like to parse.
