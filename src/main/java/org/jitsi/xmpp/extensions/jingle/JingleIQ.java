...
public class JingleIQ extends IQ {
     ...
     * a random session identifier generated by the initiator, which effectively
     * maps to the local-part of a SIP "Call-ID" parameter
     */
    private String sid;
     ...
     * The value of the 'action' attribute MUST be one of the values enumerated
     * here. If an entity receives a value not defined here, it MUST ignore the
     * attribute and MUST return a
     * <tt>bad-request</tt> error to the sender. There is no default value for
     * the 'action' attribute.
     * @param sid this element's session ID value. A "sid" is a random session
     ...
     * to easily determine the purpose of a jingle IQ. A telephony initiation IQ
     * would for example contain a <tt>content</tt> element of type {@link
