...
public enum SessionInfoType {
     ...
     * again actively participating in the session after having been on mute or
     * having put the other party on hold. The <tt>active</tt> element applies
     * to all aspects of the session, and thus does not possess a 'name'
     * attribute.
     */
    active,
    /**
     ...
     * sending media to the other party but continuing to accept media from the
     * other party.
     */
    mute,
    /**
