...
/**
 * Status extension included in MUC presence by Jibri to indicate its overall
 * status. Overall status is defined by two sub-extensions:
...
public class JibriStatusPacketExt
    ...
    /**
     * Provides a convenient helper to determine if this Jibri is available or
     * not by looking at both the busy status and the health status.
     *
     * @return true if this Jibri should be considered available for use
     * according to this presence, false otherwise
     */
